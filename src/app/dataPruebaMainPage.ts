...
import { JugadorDetail } from "./jugador/jugador-detail";
...
export const DataMejorJugador =  new JugadorDetail(1,"Jairo","2000-05-26", "Bogotá", "https://thispersondoesnotexist.com/image",7, [torneo],[partida])
